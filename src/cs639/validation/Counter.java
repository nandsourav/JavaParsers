 ...
 */
//eoneil for cs639: commented out unused deprecated classes
//eoneil for cs639: use default parser unless user uses -p flag
package cs639.validation;

import java.io.PrintWriter;

import org.xml.sax.Attributes;
// deprecated: import org.xml.sax.Parser;
...
public class Counter
    ...
    /** Default parser name. */
    protected static final String DEFAULT_PARSER_NAME = "com.sun.org.apache.xerces.internal.parsers.SAXParser";
	...
	String schemaURL = null;
        ...
        for (int i = 0; i < argv.length; i++) {
            ...
            if (arg.startsWith("-")) {
                ...
                if (option.equals("p")) {
                    ...
                    try {
                        ...
                        try {
			    //deprecated       Parser sax1Parser = ParserFactory.makeParser(parserName);
			    // parser = new ParserAdapter(sax1Parser);
                            // System.err.println("warning: Features and properties not supported on SAX1 parsers.");
                        }
                        catch (Exception ex) {
                            parser = null;
                            System.err.println("error: Unable to instantiate parser ("+parserName+")"+ ex);
                        }
                    }
                    continue;
                }
            ...
            if (parser == null) {
                ...
                // create parser
                try {
		    // cs639: use default parser that comes with J2SE
		    // or use -p to specify another
                    parser = XMLReaderFactory.createXMLReader();
		    //DEFAULT_PARSER_NAME);
                }
                catch (Exception e) {
                    System.err.println("error: Unable to instantiate default parser");
                    continue;
                }
            }
            // set parser features

	    // added by eoneil: for new -schema flag
	    try {
		if (validation && schemaValidation && schemaURL != null)
		    parser.setProperty(JAXP_SCHEMA_SOURCE, schemaURL); // set specified schema to be used in validation
	    } catch (SAXException e) {
                System.err.println("warning: Parser does not support feature ("+ JAXP_SCHEMA_SOURCE + ")");
            }
            try {
    ...
    private static void printUsage() {
        ...
        System.err.println("  -schema schemaURL   Set schema to use.");
